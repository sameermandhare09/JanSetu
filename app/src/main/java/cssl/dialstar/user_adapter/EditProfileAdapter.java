...
public class EditProfileAdapter extends ArrayAdapter<Dialstar> {
    ...
    public EditProfileAdapter(Activity context, int resouceId, int textviewId, ArrayList<Dialstar> list){
