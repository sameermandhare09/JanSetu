...
/**
 * Created by catseye on 7/12/17.
 */

public class EditProfileAdapter extends ArrayAdapter<DialstarPojo> {
    ...
    public EditProfileAdapter(Activity context, int resouceId, int textviewId, ArrayList<DialstarPojo> list){
