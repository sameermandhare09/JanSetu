...
/**
 * Created by catseye on 21/12/17.
 */
...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    public ViewPagerAdapter(Context context, ArrayList<DialstarPojo> data) {
        this.dataSet = data;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.discussion_header1, container,
                false);
        ...
        namesharepref = mlaPref.getString("name","");
...
*/
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        txtcreatedby = (TextView)itemView.findViewById(R.id.txtcreatedby);
        txtcreatedby.setText("BY:"+dataSet.get(position).getRepresentativename());
        ...
        try {
            ...
            for (int i=0;i<jsonArray.length();i++) //every object will be taken one by one to convert required elements from JSON to String
            {
                ...
                txt.setTextColor(context.getColor(R.color.bright_foreground_disabled_holo_dark));
                linearLayout.addView(txt);
...
*//*
                ...
                TextView tv = new TextView(context);
                tv.setText("BY: "+name);
                tv.setTextColor(context.getColor(R.color.bright_foreground_disabled_holo_dark));
                // Defining the layout parameters of the TextView
                RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(
                        RelativeLayout.LayoutParams.WRAP_CONTENT,
                        RelativeLayout.LayoutParams.WRAP_CONTENT);
                ...
                TextView txt2=new TextView(context);
                txt2.setText(date1);
                txt2.setTextColor(context.getColor(R.color.bright_foreground_disabled_holo_dark));
                RelativeLayout.LayoutParams lp1 = new RelativeLayout.LayoutParams(
                        RelativeLayout.LayoutParams.WRAP_CONTENT,
                        RelativeLayout.LayoutParams.WRAP_CONTENT);
                lp1.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
