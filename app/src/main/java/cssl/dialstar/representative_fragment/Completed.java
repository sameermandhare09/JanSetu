...
public class Completed extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public Completed(int x,int y,String representative,int flag){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(flag==1){
            ...
            new HttpRequestTaskNewCount( userid, usertype1, grievancecategoryid).execute();
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
           ...
           // NewComplaint newComplaint = new NewComplaint(grievancecategoryid,representativeid,representative,flag);

          //  new HttpRequestTaskNewCount( userid, usertype1, grievancecategoryid).execute();
           // newComplaint.loaddata();
           // Grievance.setTabCount(0,2);
           //NewComplaint newComplaint = new NewComplaint(grievancecategoryid,representativeid,representative,flag);
        }
    ...
    public  class HttpRequestTaskNewCount extends AsyncTask<Void, Void, ArrayList<DialstarPojo>> {
        ...
        int userid3=0;
        String usertype3="";
        int grievancecategoryid3=0;


        public HttpRequestTaskNewCount(int userid, String usertype1, int grievancecategoryid) {

            this.userid3=userid;
            this.usertype3=usertype1;
            this.grievancecategoryid3=grievancecategoryid;
        }
        ...
        protected ArrayList<DialstarPojo> doInBackground(Void... params) {
            try {
                ...
                final String url2 = config.representativeremoteurl+"admin/app/getNewGrievanceDetails/"+userid3+"/"+usertype3+"/"+grievancecategoryid3;


                Log.e("GetNewGrievanceDetail", url2);
...
//           Log.i("size", myPojo.size() + "");
    ...
    private class HttpRequestTaskreq extends AsyncTask<Void, Void, ArrayList<DialstarPojo>> {
        ...
        protected ArrayList<DialstarPojo> doInBackground(Void... params) {
            try {
                //final String url2 = config.getGetCompletedGrievanceDetails()+userid+"/"+usertype1+"/"+grievancecategoryid;
                final String url2 = config.representativeremoteurl+"admin/app/getCompletedGrievanceDetails/ "+userid+"/"+usertype1+"/"+grievancecategoryid;
